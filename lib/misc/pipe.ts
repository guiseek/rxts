import type { ReturnPipeType } from '../types/return-pipe-type'
import { reduce } from './reduce'
import { pipe1 } from './pipe1'

/**
 * Executa a composição da função da esquerda para a direita.
 * O primeiro argumento pode ter qualquer valor; os argumentos restantes devem ser unários.
 *
 * @example
 * ```ts
 * pipe(
